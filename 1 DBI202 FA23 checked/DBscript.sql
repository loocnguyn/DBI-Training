...
********************************************************************************/
IF EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE name = N'[Car_Dealership]')
BEGIN
	ALTER DATABASE [Car_Dealership] SET OFFLINE WITH ROLLBACK IMMEDIATE;
	ALTER DATABASE [Car_Dealership] SET ONLINE;
...
GO
/****** Object:  Table [dbo].[Customer]    Script Date: 6/17/2023 11:57:19 AM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Mechanic]    Script Date: 6/17/2023 11:57:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Parts]    Script Date: 6/17/2023 11:57:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PartsUsed]    Script Date: 6/17/2023 11:57:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[SalesInvoice]    Script Date: 6/17/2023 11:57:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[SalesPerson]    Script Date: 6/17/2023 11:57:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[Service]    Script Date: 6/17/2023 11:57:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ServiceMehanic]    Script Date: 6/17/2023 11:57:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ServiceTicket]    Script Date: 6/17/2023 11:57:19 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[Cars] ([carID], [serialNumber], [model], [colour], [year]) VALUES (CAST(1122334454 AS Decimal(18, 0)), N'2ABC2ABC2ABC2ABC2', N'chevrolet', N'Silver', 2017)
INSERT [dbo].[Cars] ([carID], [serialNumber], [model], [colour], [year]) VALUES (CAST(1122334455 AS Decimal(18, 0)), N'1ABC1ABC1ABC1ABC1', N'volkswagen', N'Black', 2017)
INSERT [dbo].[Cars] ([carID], [serialNumber], [model], [colour], [year]) VALUES (CAST(1122334456 AS Decimal(18, 0)), N'3ABC3ABC3ABC3ABC3', N'Tundra LX', N'Gray', 2019)
INSERT [dbo].[Cars] ([carID], [serialNumber], [model], [colour], [year]) VALUES (CAST(1122334457 AS Decimal(18, 0)), N'4ABC4ABC4ABC4ABC4', N'plymouth', N'Tan', 2019)
INSERT [dbo].[Cars] ([carID], [serialNumber], [model], [colour], [year]) VALUES (CAST(1122334458 AS Decimal(18, 0)), N'5ABC5ABC5ABC5ABC5', N'amc', N'White', 2020)
INSERT [dbo].[Cars] ([carID], [serialNumber], [model], [colour], [year]) VALUES (CAST(1122334459 AS Decimal(18, 0)), N'6ABC6ABC6ABC6ABC6', N'ford', N'Black', 2017)
INSERT [dbo].[Cars] ([carID], [serialNumber], [model], [colour], [year]) VALUES (CAST(1122334460 AS Decimal(18, 0)), N'7ABC7ABC7ABC7ABC7', N'Vehicle', N'Silver', 2019)
INSERT [dbo].[Cars] ([carID], [serialNumber], [model], [colour], [year]) VALUES (CAST(1122334470 AS Decimal(18, 0)), N'8ABC8ABC8ABC8ABC8', N'pontiac', N'Gray', 2017)
INSERT [dbo].[Cars] ([carID], [serialNumber], [model], [colour], [year]) VALUES (CAST(1122334471 AS Decimal(18, 0)), N'9ABC9ABC9ABC9ABC9', N'Escape', N'Tan', 2020)
INSERT [dbo].[Cars] ([carID], [serialNumber], [model], [colour], [year]) VALUES (CAST(1122334472 AS Decimal(18, 0)), N'10ABC10ABC10ABC10', N'TLX', N'White', 2017)
INSERT [dbo].[Cars] ([carID], [serialNumber], [model], [colour], [year]) VALUES (CAST(1122334473 AS Decimal(18, 0)), N'11ABC11ABC11ABC11', N'buick', N'Black', 2017)
INSERT [dbo].[Cars] ([carID], [serialNumber], [model], [colour], [year]) VALUES (CAST(1122334474 AS Decimal(18, 0)), N'12ABC12ABC12ABC12', N'citroen', N'Silver', 2019)
INSERT [dbo].[Cars] ([carID], [serialNumber], [model], [colour], [year]) VALUES (CAST(1122334475 AS Decimal(18, 0)), N'13ABC13ABC13ABC13', N'toyota', N'Gray', 2017)
INSERT [dbo].[Cars] ([carID], [serialNumber], [model], [colour], [year]) VALUES (CAST(1122334476 AS Decimal(18, 0)), N'14ACB14ABC14ABC14', N'Escape', N'Tan', 2020)
INSERT [dbo].[Cars] ([carID], [serialNumber], [model], [colour], [year]) VALUES (CAST(1122334477 AS Decimal(18, 0)), N'15ABC15ABC15ABC15', N'chevrolet', N'White', 2017)
INSERT [dbo].[Cars] ([carID], [serialNumber], [model], [colour], [year]) VALUES (CAST(1122334478 AS Decimal(18, 0)), N'16ABC16ABC16ABC16', N'Grand Caravan', N'Black', 2017)
INSERT [dbo].[Cars] ([carID], [serialNumber], [model], [colour], [year]) VALUES (CAST(1122334479 AS Decimal(18, 0)), N'17ABC17ABC17ABC17', N'audi', N'Silver', 2019)
INSERT [dbo].[Cars] ([carID], [serialNumber], [model], [colour], [year]) VALUES (CAST(1122334480 AS Decimal(18, 0)), N'18ABC18ABC18ABC18', N'bmw', N'Gray', 2017)
INSERT [dbo].[Cars] ([carID], [serialNumber], [model], [colour], [year]) VALUES (CAST(1122334481 AS Decimal(18, 0)), N'19ABC19ACB19ABC19', N'Escape', N'Tan', 2020)
INSERT [dbo].[Cars] ([carID], [serialNumber], [model], [colour], [year]) VALUES (CAST(1122334482 AS Decimal(18, 0)), N'20ABC20ABC20ABC20', N'TLX', N'White', 2017)
INSERT [dbo].[Cars] ([carID], [serialNumber], [model], [colour], [year]) VALUES (CAST(1122334483 AS Decimal(18, 0)), N'21ABC21ABC21ABC21', N'dodge', N'Black', 2017)
INSERT [dbo].[Customer] ([custID], [custName], [phone], [sex], [cusAddress]) VALUES (CAST(11013 AS Decimal(18, 0)), N'Phạm Nguyên Dũng', CAST(906572342 AS Decimal(18, 0)), N'M    ', N'Long An')
INSERT [dbo].[Customer] ([custID], [custName], [phone], [sex], [cusAddress]) VALUES (CAST(11019 AS Decimal(18, 0)), N'Nguyễn Thị Thùy Dung', CAST(753634123 AS Decimal(18, 0)), N'F    ', N'TP. Hà Nội')
INSERT [dbo].[Customer] ([custID], [custName], [phone], [sex], [cusAddress]) VALUES (CAST(11024 AS Decimal(18, 0)), N'Hà Mỹ Duyên', CAST(763989821 AS Decimal(18, 0)), N'F    ', N'Nam Định')
INSERT [dbo].[Customer] ([custID], [custName], [phone], [sex], [cusAddress]) VALUES (CAST(11032 AS Decimal(18, 0)), N'Bùi Phương Ngọc', CAST(903426751 AS Decimal(18, 0)), N'M    ', N'Vũng Tàu')
INSERT [dbo].[Customer] ([custID], [custName], [phone], [sex], [cusAddress]) VALUES (CAST(11037 AS Decimal(18, 0)), N'Nguyễn Thạc Hải', CAST(112755456 AS Decimal(18, 0)), N'M    ', N'Khánh Hòa')
INSERT [dbo].[Customer] ([custID], [custName], [phone], [sex], [cusAddress]) VALUES (CAST(11051 AS Decimal(18, 0)), N'Phan Thành Đăng', CAST(12272718 AS Decimal(18, 0)), N'M    ', N'Khánh Hòa')
INSERT [dbo].[Customer] ([custID], [custName], [phone], [sex], [cusAddress]) VALUES (CAST(11055 AS Decimal(18, 0)), N'Nguyễn Thị Minh Hằng', CAST(987653421 AS Decimal(18, 0)), N'F    ', N'Nha Trang')
INSERT [dbo].[Customer] ([custID], [custName], [phone], [sex], [cusAddress]) VALUES (CAST(11076 AS Decimal(18, 0)), N'Đoàn Minh Đạo', CAST(879355621 AS Decimal(18, 0)), N'M    ', N'Huế')
INSERT [dbo].[Customer] ([custID], [custName], [phone], [sex], [cusAddress]) VALUES (CAST(11077 AS Decimal(18, 0)), N'Nguyễn Thị Thu Hằng', CAST(81200176 AS Decimal(18, 0)), N'F    ', N'Bình Thuận')
INSERT [dbo].[Customer] ([custID], [custName], [phone], [sex], [cusAddress]) VALUES (CAST(11078 AS Decimal(18, 0)), N'Vương Thị Kim Cúc', CAST(904532178 AS Decimal(18, 0)), N'F    ', N'Huế')
INSERT [dbo].[Customer] ([custID], [custName], [phone], [sex], [cusAddress]) VALUES (CAST(11089 AS Decimal(18, 0)), N'Huỳnh Thị Ngọc Điệp', CAST(907772818 AS Decimal(18, 0)), N'F    ', N'Thanh Hóa')
INSERT [dbo].[Customer] ([custID], [custName], [phone], [sex], [cusAddress]) VALUES (CAST(11095 AS Decimal(18, 0)), N'Hồ Đức Trung Hữu', CAST(1278654321 AS Decimal(18, 0)), N'M    ', N'Thanh Hóa ')
INSERT [dbo].[Customer] ([custID], [custName], [phone], [sex], [cusAddress]) VALUES (CAST(11098 AS Decimal(18, 0)), N'Nguyễn Thị Minh Hà', CAST(907865432 AS Decimal(18, 0)), N'F    ', N'TP. Hà Nội')
